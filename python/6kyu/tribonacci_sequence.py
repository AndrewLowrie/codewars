...
# Fibonacci, but summing the last 3 (instead of 2) numbers of
...
# non-negative number; if n == 0, then return an empty array and
...
def tribonacci(signature, n):
    ...
    counter = 0
    while (n > 3):
        next_num = signature[counter] + signature[counter+1] + signature[counter+2]
